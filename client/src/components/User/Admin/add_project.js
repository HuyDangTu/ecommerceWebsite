...
import {getGenuses,getTypes,addProduct,clearProduct} from '../../../actions/product_actions'
...
class AddProduct extends Component {
    ...
    componentDidMount(){
        ...
        this.props.dispatch(getGenuses()).then(response =>{
            const newFormData = populateOptionFields(formData, this.props.products.genuses,'genus')
                ...
                <form onSubmit={(event)=>this.submitForm(event)}>
                    ...
                    <div className='form_fields'>
                        <div className="form_devider">
                            ...
                            <FormField
                                id={'genus'}
                                formData={this.state.formData.genus}
                                //Hàm change nhận vào một element và gọi đến hàm updateForm(element) 
                                change={(element) => this.updateForm(element)}
                            />
                            <FormField
